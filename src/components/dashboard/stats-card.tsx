...
export default function StatsCard({ label, value, change, icon: Icon, accent = "#7C3AED" }: StatsCardProps) {
  const up = change >= 0;
  return (
    <div className="group rounded-xl border border-border bg-muted/50 p-5 transition-all duration-200 hover:-translate-y-0.5 hover:border-[#7C3AED]/50 hover:shadow-lg hover:shadow-[#7C3AED]/10">
