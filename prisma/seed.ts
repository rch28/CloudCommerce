      ...
      data: [
        {
          ...
          sortOrder: 0,
          content: {
            title: "Welcome to Demo Store Co.",
            subtitle: "Discover premium audio gear and cutting-edge wearable technology.",
            ctaText: "Shop Now",
            ctaLink: "/products",
            alignment: "center",
          },
        },
        {
          ...
          sortOrder: 1,
          content: {
            body: "<h2>Why Choose Us</h2><ul><li><strong>Premium Quality</strong> — Hand-picked products from top brands.</li><li><strong>Fast Shipping</strong> — Free shipping on orders over $50.</li><li><strong>24/7 Support</strong> — We're here to help anytime.</li></ul>",
          },
        },
        {
          pageId: homePage.id,
