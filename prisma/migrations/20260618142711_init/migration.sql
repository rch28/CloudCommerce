...
-- CreateIndex
CREATE UNIQUE INDEX "Store_slug_tenantId_key" ON "Store"("slug", "tenantId");

-- CreateIndex
CREATE UNIQUE INDEX "StaffMember_email_tenantId_key" ON "StaffMember"("email", "tenantId");
...
-- AddForeignKey
ALTER TABLE "WebhookLog" ADD CONSTRAINT "WebhookLog_webhookId_fkey" FOREIGN KEY ("webhookId") REFERENCES "WebhookEvent"("id") ON DELETE CASCADE ON UPDATE CASCADE;
